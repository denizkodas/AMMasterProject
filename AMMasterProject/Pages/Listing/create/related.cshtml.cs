...
namespace AMMasterProject.Pages.Listing.create
{
    ...
    [BindProperties]
    public class relatedModel : PageModel
    {
        #region Models
        ...
        public relatedModel(MyDbContext context, ProductHelper productHelper)
        {
            _dbContext = context;
        ...
        public void setup(Guid productguid)
        {
            ...
            relatedProductslist = ProductHelper.ParseMetaDataProductRelated(itemListing.RelatedItemMetaData).Where(u => u.RelatedType == 0).ToList();
