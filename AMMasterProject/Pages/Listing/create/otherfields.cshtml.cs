...
namespace AMMasterProject.Pages.Listing.create
{
    ...
    public class otherfieldsModel : PageModel
    {
        ...
        public List<ProductOtherPropertiesMetaData> listproduct { get; set; }
        public otherfieldsModel(MyDbContext context, ProductHelper productHelper)
        {
            _dbContext = context;
...

        {
            ...
            else
            {
                ...
                listproduct = _productHelper.ParseMetaDataitemotherproperties(items.ItemOtherProperites).ToList();
        ...
        public IActionResult OnPost()
        {
            ...
            if (RouteData.Values["ID"] != null)
            {
                ...
                #region Json
                string json = _productHelper.itemotherpropertiesmetadata(0, itemotherproperties.LabelName, itemotherproperties.ValueName, items.ItemOtherProperites);
                ...
                if (items != null)
                {
                    items.ItemOtherProperites = json;
                    _dbContext.Update(items);
                    _dbContext.SaveChanges();
                }

                TempData["success"] = "Updated successfully";
                return RedirectToPage("/listing/create/otherfields", new { ID = ID });
            }
        ...
        public IActionResult OnPostDelete(string videoid)
        {
            ...
            if (up != null)
            {
                ...
                listproduct = _productHelper.ParseMetaDataitemotherproperties(up.ItemOtherProperites).ToList();
                ...
                if (indexToDelete >= 0)
                {
                    ...
                    up.ItemOtherProperites = updatedJson;
            ...
            return RedirectToPage("/listing/create/otherfields", new { ID = up.ItemGuid });
        }
    }
}
