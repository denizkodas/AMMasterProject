...
namespace AMMasterProject.Pages.Admin
{
    ...
    public class profileModel : PageModel
    {
        ...
        public profileModel(MyDbContext context, UserHelper userHelper)
        {
            _dbContext = context;
        ...
        public IActionResult OnPost()
        {
            ...
            {
                ModelState.AddModelError("UserProfile.ProfileImage", "Profile Image is required.");
            ...
            {
                ModelState.AddModelError("UserProfile.Firstname", "First Name is required.");
            ...
            {
                ModelState.AddModelError("UserProfile.Lastname", "Last name is required.");
            ...
            {
                ModelState.AddModelError("UserProfile.Email", "Email is required.");

                setup();
                return Page();
            }

            if (UserProfile.ClientDisplayName == null)
            {
                ModelState.AddModelError("UserProfile.ClientDisplayName", "Display Name is required.");
            ...
            {
                ModelState.AddModelError("UserProfile.About", "About is required.");

                setup();
                return Page();
            }

            if (UserProfile.Contactnumber == null)
            {
                ModelState.AddModelError("UserProfile.Contactnumber", "Contact number is required.");
