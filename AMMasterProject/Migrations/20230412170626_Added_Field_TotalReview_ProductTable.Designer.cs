...
namespace AMMasterProject.Migrations
{
    ...
    [Migration("20230412170626_Added_Field_TotalReview_ProductTable")]
    partial class Added_Field_TotalReview_ProductTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMMasterProject.AdsPageName", b =>
                {
                    b.Property<int>("AdsPageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdsPageId"));
                    ...
                    b.ToTable("Ads_PageName");
                });

            modelBuilder.Entity("AMMasterProject.AdsPlacement", b =>
                {
                    b.Property<int>("AdsPlacementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdsPlacementId"));
                    ...
                    b.HasKey("AdsPlacementId");

                    b.ToTable("Ads_Placement");
                });
            ...
            modelBuilder.Entity("AMMasterProject.BlogSetup", b =>
                {
                    b.Property<int>("BlogSetupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("BlogSetup_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BlogSetupId"));
                    ...
                    b.HasKey("BlogSetupId");

                    b.ToTable("Blog_Setup");
                });
            ...
            modelBuilder.Entity("AMMasterProject.Logo", b =>
                {
            ...
            modelBuilder.Entity("AMMasterProject.MainPageCategory", b =>
                {
                    b.Property<int>("MainPageCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MainPageCategoryId"));

                    b.Property<string>("MainPageCategory1")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.HasKey("MainPageCategoryId");

                    b.ToTable("MainPageCategory");
                });

            modelBuilder.Entity("AMMasterProject.MediaNote", b =>
                {
                    ...
                    b.Property<bool?>("Isaddonslider")
                        .HasColumnType("bit")
                        .HasColumnName("isaddonslider");
            ...
            modelBuilder.Entity("AMMasterProject.OrderChargesV2", b =>
                {
                    b.Property<int>("OrderChargeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderChargeId"));
                    ...
                    b.Property<Guid?>("OrderChargeGuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("OrderChargeGUID")
                        .HasDefaultValueSql("(newid())");

                    b.Property<Guid?>("OrderMasterGuid")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("OrderMasterGUID");
                    ...
                    b.ToTable("Order_Charges_V2");
                });

            modelBuilder.Entity("AMMasterProject.OrderDeliveryV2", b =>
                {
                    ...
                    b.Property<Guid?>("OrderShippingGuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("OrderShippingGUID")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.ToTable("Order_Delivery_V2");
                });

            modelBuilder.Entity("AMMasterProject.OrderDisbursement", b =>
                {
                    b.Property<int>("OrderEarningId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderEarningId"));
                    ...
                    b.HasKey("OrderEarningId");

                    b.ToTable("Order_Disbursement");
                });

            modelBuilder.Entity("AMMasterProject.OrderIdgenerationV2", b =>
                {
                    b.Property<Guid>("Ordergeneratedguidid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ordergeneratedguidid")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.HasKey("Ordergeneratedguidid")
                        .HasName("PK__OrderIDG__CFBD77621CD6197B");

                    b.ToTable("OrderIDGeneration_V2");
                });

            modelBuilder.Entity("AMMasterProject.OrderMasterV2", b =>
                {
                    ...
                    b.Property<string>("ConversionCurrencySymbol")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<Guid?>("GroupOrderGeneratedGuid")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("GroupOrderGeneratedGUID");
                    ...
                    b.Property<string>("LastOrderStatus")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<decimal?>("ProductAttributePrice")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.ToTable("Order_Master_V2");
                });

            modelBuilder.Entity("AMMasterProject.OrderStatusV2", b =>
                {
                    ...
                    b.ToTable("Order_Status_V2");
                });

            modelBuilder.Entity("AMMasterProject.OrderVariationV2", b =>
                {
                    b.Property<int>("OrderVariationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderVariationId"));
                    ...
                    b.Property<Guid?>("OrderVariationGuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("OrderVariationGUID")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.Property<string>("ProductAttributeSelectedOption")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.HasKey("OrderVariationId");

                    b.ToTable("Order_Variation_V2");
                });
            ...
            modelBuilder.Entity("AMMasterProject.PageCategory", b =>
                {
                    ...
                    b.Property<string>("PageCategory1")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("AMMasterProject.PageCategoryDetail", b =>
                {
                    b.Property<int>("PageCategoryDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PageCategoryDetailId"));

                    b.Property<DateTime?>("InsertDate")
                        .HasColumnType("datetime");

                    b.Property<string>("PageCategoryDescriptoin")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("PageCategoryDetailId")
                        .HasName("PK_PageCategoryDetail");

                    b.ToTable("PageCategoryDetails");
                });
            ...
            modelBuilder.Entity("AMMasterProject.ProductSeo", b =>
                {
            ...
            modelBuilder.Entity("AMMasterProject.SocialMedium", b =>
                {
            ...
            modelBuilder.Entity("AMMasterProject.UsersMembership", b =>
                {
            ...
            modelBuilder.Entity("AMMasterProject.UsersProfile", b =>
                {
                    ...
                    b.Property<bool?>("IsMembershipFree")
                        .HasColumnType("bit");
